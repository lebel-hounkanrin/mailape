...
from .views import (MailingListListView, CreateMailingListView, DeleteMailingListView,
   MailingListDetailView, SubscribeToMailingListView, ThankYouForSubscribingView, ConfirmSubscriptionView,
   UnsubscribeView, CreateMessageView, MessageDetailView)
...
urlpatterns = [
   ...
   path('subscribe/confirmation/<uuid:pk>', ConfirmSubscriptionView.as_view(), name='confirm_subscription'),
   path('unsubscribe/<uuid:pk>', UnsubscribeView.as_view(), name='unsubscribe'),
   path('<uuid:mailinglist_id>/message/new', CreateMessageView.as_view(), name='create_message'),
